...
All the environments are registered in the `lite6Test` extension. They start
...
import lite6Test.tasks  # noqa: F401


def main():
    """Print all environments registered in `lite6Test` extension."""
